...
const ReservationsPage = async ({ searchParams }: { searchParams: IParams }) => {
    ...
    const { reservations, totalPages } = await getReservations({ ...searchParams, userId: user.id });
        ...
        return (
            <ClientOnly>
                <EmptyState
                    ...
                    subtitle='Похоже, вы не забронировали ни одного места.'
                    showButton
